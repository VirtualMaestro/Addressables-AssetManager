...
namespace Asset_Manager.Editor
{
    public class Il2CPPCustomFlag : IPreprocessBuildWithReport
    {
        ...
        public void OnPreprocessBuild(BuildReport report)
        {
            ...
            var backend = UnityEditor.PlayerSettings.GetScriptingBackend(UnityEditor.BuildPipeline.GetBuildTargetGroup(UnityEditor.EditorUserBuildSettings.activeBuildTarget));
